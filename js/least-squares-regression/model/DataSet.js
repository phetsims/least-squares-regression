...
define( function( require ) {
  ...
  DataSet.SPENDING_SALARY = createDataSet( 'spendingSalary', new Range( 0, 10000 ), new Range( 0, 48000 ),
    [
      {x: 19583, y: 3346},
      {x: 20263, y: 3114},
      {x: 20325, y: 3554},
  ...
  DataSet.USER_YEAR = createDataSet( 'userYear', new Range( 0, 2100 ), new Range( 0, 20 ),
    [
      {x: 0, y: 2.626964881},
      {x: 1, y: 4.283257864},
      {x: 2, y: 6.851845762},
  ...
  DataSet.GASOLINE_YEAR = createDataSet( 'gasolineYear', new Range( 0, 4 ), new Range( 0, 45 ),
    [
      {x: 0, y: 0.73},
      {x: 1, y: 1.01},
      {x: 2, y: 1.25},
  ...
  DataSet.SPEED_DISTANCE = createDataSet( 'speedDistance', new Range( 0, 50 ), new Range( 0, 32 ),
    [
  ...
  DataSet.HEIGHT_SHOE = createDataSet( 'heightShoe', new Range( 0, 80 ), new Range( 0, 15 ),
    [
      {x: 5.5, y: 60},
      {x: 6, y: 60},
      {x: 7, y: 60},
