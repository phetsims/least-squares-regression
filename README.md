...
(5) Open in the browser: `http://localhost/least-squares-regression/least-squares-regression_en.html` (You will probably
...
Help us improve, create a <a href="http://github.com/phetsims/least-squares-regression/issues/new" target="_blank">New
Issue</a>
