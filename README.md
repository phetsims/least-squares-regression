...
(3) Open `http://localhost/least-squares-regression/least-squares-regression_en.html` (You will probably need to modify this URL based on your HTTP port and relative path.)
